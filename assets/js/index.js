...
var vm = new Vue({
    ...
    data: {
      points: [
        ...
        {title: '視聴者目線の映像配信', body: '1本の映像を平均3〜4分のチャプターに分けて配信します　映像の視聴傾向として3分以内が最もみてもらえるというデータを参考に、技術的な特徴から30〜60分と長尺になる映像を10〜20本にチャ プター化。休憩中や移動中、就寝前のちょっとした時間で視聴できる手軽な環境を提供しています。', imgUrl: 'assets/images/kmx002.png'},
